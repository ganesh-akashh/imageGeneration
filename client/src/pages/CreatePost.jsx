...
const CreatePost = () => {
  ...
  const [generatingImg, setGeneratingImg] = useState(false);  //used when making contact with api.
    ...
    if (form.prompt) {
      try {
        ...
        if (data?.sucess) {
          ...
          setForm({ ...form, photo: randomImage.src });
        }
      } catch (err) {
        alert(err);
        console.log(err);
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[700px]">Create Imaginative and visually stunning images through DALL-E AI and share them with the community</p>
      </div>
